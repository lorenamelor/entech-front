...
export const selectIsRequestSurvey: Selector<boolean> = ({ surveyReducer }) => surveyReducer.isRequestSurvey;
...
export default reducerWithInitialState(INITIAL_STATE)
	.case(surveyRequest.started, (state: IState) => ({
		...state,
		isRequestSurvey: true,
	}))
	.case(surveyRequest.failed, (state: IState) => ({
		...state,
		isRequestSurvey: false,
	}))
